...
def create_hf_model(model_class,
    ...
    if rope_pi:
        ...
        model_config.max_position_embeddings = model_config.max_position_embeddings*rope_ratio
        setattr(model_config, "rope_pi", rope_pi)
        setattr(model_config, "rope_ratio", rope_ratio)
        #model.config['rope_pi'] = rope_pi
        #model.config['rope_ratio'] = rope_ratio
